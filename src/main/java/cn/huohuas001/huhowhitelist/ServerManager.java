...
import cn.huohuas001.huhowhitelist.HuHoWhiteList;
import cn.huohuas001.huhowhitelist.ConsoleSender;
...
public class ServerManager {
    ...
    public static String sendCmd(String cmd, boolean disPlay, boolean clearColor) {
        ...
        HuHoWhiteList.getScheduler().runTask(() -> {
            msgList.clear();
            HuHoWhiteList.getPlugin().getServer().dispatchCommand(commandSender, cmd);
        });

        HuHoWhiteList.getScheduler().runTaskLaterAsynchronously(() -> {
